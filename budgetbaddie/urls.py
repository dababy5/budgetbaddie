...
from accounts.views import login_view, signup_view,connect_bank,test_sms, spending_chart_data,gemini_process_purchases,create_budget_plan,delete_budget_plan
...
urlpatterns = [
    ...
    path("user_home/delete_plan/<int:plan_id>/", delete_budget_plan, name="delete_budget_plan"),
    path("spending-data/", spending_chart_data, name="spending_chart_data"),
